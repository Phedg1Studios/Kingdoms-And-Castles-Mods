...
namespace Phedg1Studios {
    namespace Shared {
        public class Util : MonoBehaviour {
            ...
            private static int outlineColor = -1;
            ...
            void Update() {
                if (Input.GetKeyDown(KeyCode.F2)) {
                    LogComponentsOfObject(GameUI.inst.witchUI.gameObject);
                    //GameObject.DestroyImmediate(GameUI.inst.CellHighlighter);
